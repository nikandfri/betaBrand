          ...
          <div className="text-center pb-12 md:pb-16">
            ...
            <div className="max-w-3xl mx-auto">
              <p
                ...
                data-aos-delay="150"
              >
                DNB Beta enables us to test new ideas and generate customer
                insights fast and efficient. You have an idea just shoot!
              </p>
              <div
              ...
              >
                ...
                <div>
                  <a
                    className="btn text-white bg-dnb-400 hover:bg-gray-800 w-full sm:w-auto sm:ml-4"
                    href="#0"
                  >
                    Learn more
                  </a>
